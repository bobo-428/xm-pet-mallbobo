<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #f3a119">欢 迎 登 录</div>
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item>
          <el-button size="large" type="primary" style="width: 100%; background-color: #f3a119; border-color: #f3a119" @click="login">登 录</el-button>
        </el-form-item>
